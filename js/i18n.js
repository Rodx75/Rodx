(function () {
    ...
    var translations = {
        en: {
            ...
            "nav.contact": "Contact",
            "hero.im": "I'm",
            "hero.roles": "Software Developer, Odoo Technical Developer, .NET / C# Developer, React &amp; Python Developer",
            "hero.contactBtn": "Contact Me",
            "hero.cvBtn": "View Resume",
            "about.eyebrow": "About Me",
            "about.title": "Full-Stack &amp; ERP Developer",
            "about.text": "Software developer focused on building business solutions and modern web platforms. I have hands-on experience implementing advanced customizations in <strong>Odoo ERP (Python/XML)</strong>, building dynamic, interactive interfaces with <strong>React</strong>, and developing APIs and backend services with <strong>.NET / C#</strong>. Passionate about clean architecture, process optimization, and full-stack web development.",
            "about.downloadBtn": "Download Resume",
            "about.skill3": ".NET / C# &amp; Backend (PostgreSQL, REST APIs)",
